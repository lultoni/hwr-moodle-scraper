...
- **After changes**: run `npx vitest run` — all 713 tests must pass; commit with a contextual message
...
- All 22 timeline steps fully implemented; 713/713 tests passing (46 test files)
- Full CLI: auth, scrape, status, wizard, reset, tui + first-run wizard + clean
- 40 cleanup/improvement passes completed; current version: `0.4.0`
