...
- **After changes**: run `npx vitest run` — all 813 tests must pass; commit with a contextual message
...
- All 22 timeline steps fully implemented; 826/826 tests passing (48 test files)
- Full CLI: auth, scrape, status, wizard, reset, tui + first-run wizard + clean
- 52 cleanup/improvement passes completed; current version: `0.8.0`
