...
- **After changes**: run `npx vitest run` — all 857 tests must pass; commit with a contextual message
...
- All 22 timeline steps fully implemented; 857/857 tests passing (49 test files)
- Full CLI: auth, scrape, status, wizard, reset, tui + first-run wizard + clean
- 54 cleanup/improvement passes completed + 1 bug fix pass; current version: `0.9.1`
