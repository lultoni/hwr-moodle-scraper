...
- All 22 timeline steps fully implemented; 920/920 tests passing (50 test files)
- Full CLI: auth, scrape, status, wizard, reset, tui + first-run wizard + clean
- 59 cleanup/improvement passes completed + 1 bug fix pass; current version: `0.12.1`
