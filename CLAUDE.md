...
- **After changes**: run `npx vitest run` — all 856 tests must pass; commit with a contextual message
...
- All 22 timeline steps fully implemented; 856/856 tests passing (49 test files)
- Full CLI: auth, scrape, status, wizard, reset, tui + first-run wizard + clean
- 54 cleanup/improvement passes completed; current version: `0.9.1`
