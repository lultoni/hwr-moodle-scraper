...
- **After significant changes**: run `npx vitest run` — all 512 tests must pass; commit with a contextual message
...
- All 22 timeline steps fully implemented; 512/512 tests passing (38 test files)
