...
program
  ...
  .option("--show-evictions", "Print a list of stale generated files deleted during cleanup (implied by --verbose)", false)
  ...
  .action(async (opts: {
    ...
    if (opts.showEvictions) scrapeOpts.showEvictions = true;
